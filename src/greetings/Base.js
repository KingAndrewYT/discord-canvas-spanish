...
module.exports = class Welcomes {
    ...
    async toAttachment() {
        ...
        const bordes = await Canvas.loadImage('https://i.ibb.co/mS7QspF/welcome.png');
        ...
        // Draw avatar circle
            const borde1 = await Canvas.loadImage('https://i.ibb.co/9HVsnKT/welcomeborder.png');
            ...
            const borde = await Canvas.loadImage('https://i.ibb.co/9HVsnKT/welcomeborder.png');
